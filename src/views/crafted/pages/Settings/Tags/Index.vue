<template>
  ...
  <div>
    <div class=" d-flex flex-stack">
      <KTToolbar/>
      <button class="btn btn-primary btn-sm" @click="$router.push({name:'create_tag'})">
          ...
          <div class="table-responsive">
            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer table-striped">
              ...
              <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase">
                ...
                <th class="text-start">{{ $t("campaigns_count") }}</th>
                      ...
                      <div
                        ...
                        <div class="menu-item px-3">
                          <a class="menu-link px-3"
                             @click="$router.push({name:'edit_tag',params:{id:item.id}})">
    ...
    const deleteRow = (item, key) => {
      Swal.fire({
        ...
        preConfirm: (result) => {
          ...
          state.loading = true;
          return store.dispatch("moduleTag/deleteTag", payload)
              .then(({data}) => {
                actionLoader("hide");
