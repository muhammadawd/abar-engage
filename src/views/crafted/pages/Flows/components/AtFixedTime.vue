      ...
      template: `
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            ...
            <input type="date" class="form-control" v-model="$parent.localValue.sendDate" />
          </div>
          <div class="col-md-6">
            <label class="form-label required">Time</label>
            <input type="time" class="form-control" v-model="$parent.localValue.sendTime" />
          </div>
        </div>
      `
    }
