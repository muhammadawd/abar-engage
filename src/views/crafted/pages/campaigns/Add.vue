<template>
  ...
  <div>
    ...
    <section v-if="step==2">
      ...
      <div v-if="$route.params.type == 'custom'" class="row mt-5 match-height">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header" style="min-height: 50px;">
              <div>
                <h4 class="card-title fw-bolders mb-0 pt-3">Content</h4>
                <small class="text-muted">Configure the API request</small>
              </div>
              <div>
                <div class="symbol symbol-circle symbol-45px mt-2">
                  <div class="symbol-label bg-primary">
            ...
            <div class="card-body">
              <div class="row mt-2">
                <div class="col-md-4">
                  ...
                  <div class="d-flex">
                    <div v-for="method in ['get','post','put','delete']" class="me-3">
                      <div class="form-check form-check-custom form-check-solids">
                        <input class="form-check-input" name="method"
                               type="radio" v-model="custom.method"
                               :value="method"
                               :id="method"/>
                        <label class="form-check-label text-uppercase" :for="method">
                          {{ method }}
                        </label>
                      </div>
                    </div>
              ...
              <div class="row mt-2 align-items-center">
                <div class="col-md-8">
                  <label>URL Parameters <span class="text-danger">*</span></label>
                  <div class="row mt-3" v-for="(header,headerKey) in custom.params">
                    <div class="col-4">
                      <input class="form-control" v-model="header.key" placeholder="Enter Key"/>
                    </div>
                    <div class="col-4">
                      <input class="form-control" v-model="header.value" placeholder="Enter Value"/>
                    </div>
                    <div class="col-2 text-center">
                      <button v-if="headerKey != 0" type="button" class="btn btn-sm p-0 btn-light"
                              @click="custom.params.splice(headerKey, 1);">
                        <KTIcon icon-name="trash" icon-class="fs-2"/>
                      </button>
                    </div>
                  </div>
                  <div class="mt-2">
                    <a href="javascript:void(0)" @click="custom.params.push({key:'',value:''})">
                      + KV Pair
                    </a>
                  </div>
                </div>
              ...
              <div class="row mt-4 align-items-center">
                <div class="col-md-8">
                  ...
                  <div class="row mt-3" v-for="(header,headerKey) in custom.headers">
                    <div class="col-4">
                      <input class="form-control" v-model="header.key" placeholder="Enter Key"/>
                    </div>
                    <div class="col-4">
                    ...
                    <div class="col-2 text-center">
                      <button v-if="headerKey != 0" type="button" class="btn btn-sm p-0 btn-light"
                              @click="custom.headers.splice(headerKey, 1);">
                        <KTIcon icon-name="trash" icon-class="fs-2"/>
                      </button>
                    </div>
                  </div>
                  <div class="mt-2">
                    <a href="javascript:void(0)" @click="custom.headers.push({key:'',value:''})">
                      + KV Pair
                    </a>
                  </div>
                </div>
              </div>
              <div class="row mt-4 align-items-center" v-if="custom.method == 'post'">
                <div class="col-md-8 mt-3">
                  <label>Body type <span class="text-danger">*</span></label>

                  <div class="d-flex mt-3">
                    <div v-for="body_type in ['form','json','raw']" class="me-3 ">
                      <div class="form-check form-check-custom form-check-solids">
                        <input class="form-check-input" name="body_type"
                               type="radio" v-model="custom.body_type"
                               :value="body_type"
                               :id="body_type"/>
                        <label class="form-check-label text-uppercase" :for="body_type">
                          {{ body_type }}
                        </label>
                      </div>
                    </div>
                  ...
                  <div class="row mt-3">
                    <div class="col-md-8">
                      ...
                      <template v-if="['form','json'].includes(custom.body_type)">

                        <div class="row mt-3" v-for="(body,bodyKey) in custom.body">
                          <div class="col-4">
                            <input class="form-control" v-model="body.key" placeholder="Enter Key"/>
                          </div>
                          <div class="col-4">
                            <input class="form-control" v-model="body.value" placeholder="Enter Value"/>
                          </div>
                          <div class="col-2 text-center">
                            <button v-if="headerKey != 0" type="button" class="btn btn-sm p-0 btn-light"
                                    @click="custom.headers.splice(bodyKey, 1);">
                              <KTIcon icon-name="trash" icon-class="fs-2"/>
                            </button>
                          </div>
                        </div>
                        <div class="mt-2">
                          <a href="javascript:void(0)" @click="custom.body.push({key:'',value:''})">
                            + KV Pair
                          </a>
                        </div>
