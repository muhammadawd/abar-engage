  ...
  <div>
        ...
        <div class="d-flex justify-content-between flex-stacks">
          <div class="cols">
            <div class="d-flex flex-stacks">
              <span
                  class="bullet bullet-dot d-flex bg-primary h-45px w-45px justify-content-center align-items-center">
                <p class="m-0 fs-2 text-white">1</p>
              </span>
              &nbsp;&nbsp;
          ...
          <div class="cols">
            <div class="d-flex flex-stacks">
              <span
                  class="bullet bullet-dot d-flex bg-primary-subtle h-45px w-45px justify-content-center align-items-center">
                <p class="m-0 fs-2">2</p>
              </span>
              &nbsp;&nbsp;
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" v-model="campaign_name" name="campaign_name" placeholder="Campaign Name"
    ...
    <div class="card mt-5">
      <div class="card-header">
        <h4 class="card-title">Target audience <span class="text-danger">*</span></h4>
      </div>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="d-flex">
              ...
              <div class="form-check form-check-custom form-check-solid">
                <input class="form-check-input" v-model="filter_user_option" type="radio" value="all_users"
                       id="flexRadioDefault"/>
              ...
              &nbsp;&nbsp;&nbsp;
              <div class="form-check form-check-custom form-check-solid">
                <input class="form-check-input" v-model="filter_user_option" type="radio" value="by_user"
              ...
              <div class="card-body">
                ...
                <template v-else>
                  ...
                  <div class="btn-group" role="group" aria-label="Radio toggle button group">
                    <input type="radio" class="btn-check" name="options" id="option1" v-model="user_option.type"
                           autocomplete="off" value="user_property">
                    <label class="btn btn-light" :class="user_option.type == 'user_property' ? 'btn-primary' : ''"
                           for="option1">User Property</label>

                    <input type="radio" class="btn-check" name="options" id="option2" v-model="user_option.type"
                           autocomplete="off" value="user_behavior">
                    <label class="btn btn-light" :class="user_option.type == 'user_behavior' ? 'btn-primary' : ''"
                    ...
                    <label class="btn btn-light" :class="user_option.type == 'user_affinity' ? 'btn-primary' : ''"
                           for="option3">User Affinity</label>

                    <input type="radio" class="btn-check" name="options" id="option4" disabled
                           v-model="user_option.type"
                           autocomplete="off" value="custom_segment">
                    <label class="btn btn-light" :class="user_option.type == 'custom_segment' ? 'btn-primary' : ''"
                  ...
                  <div class="mt-5">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <el-select name="ex_option" v-model="user_option.ex_option">
                          <el-option value="has_executed" :label="'Has Executed'">Has Executed</el-option>
                          <el-option value="has_not_executed" :label="'Has Not Executed'">Has Not Executed</el-option>
                        </el-select>
                      </div>
                      <div class="col-md-3">
                        <el-select
                      ...
                      <div class="col-md-1" v-if="user_option.event">
                        <el-select name="event_period" v-model="user_option.event_count">
                          <el-option value="exactly" :label="'Exactly'"/>
                          <el-option value="at_least" :label="'At Least'"/>
                          <el-option value="at_most" :label="'At Most'"/>
                          <el-option value="for_the_first_time" :label="'For The First Time'"/>
                          <el-option value="for_the_last_time" :label="'For The Last Time'"/>
                        </el-select>
                      </div>
                      <div class="col-md-1" v-if="user_option.event">
                        <div class="d-flex align-items-center justify-content-center">
                          <input type="number" v-model.number="user_option.times" name="times"
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-md-2" v-if="user_option.event">
                        <el-select name="event_period" v-model="user_option.event_period">
                      ...
                      <div class="col-md-1" v-if="user_option.event">
                        <div class="d-flex align-items-center justify-content-center">
                          <input type="number" v-model.number="user_option.period_times" name="times"
                                 class="form-control form-control-sm">
                        </div>
                      </div>
                      <div class="col-md-1" v-if="user_option.event">
                        <el-select name="event_period" v-model="user_option.period_times_operator">
                      ...
                      <div class="col-md-12 mt-4" v-if="user_option.event">
                        ...
                        <div class="ps-10 pe-10" v-for="(i,k) in user_option.attributes">
                          <div class="row mt-3">
                            <div class="col-2">
                              <span v-if="k ==0" class="text-muted fs-5">With Attribute</span>
                              <div v-else>
                                <div class="btn-group" role="group" aria-label="Radio toggle button group">
                                  <input type="radio" class="btn-check" name="option_operators"
                            ...
                            <div class="col-3">
                              <el-select :name="`select_${k}_attribute`" v-model="i.attribute"
                                         :placeholder="`Select Attribute`">
                                <el-option :value="'Attribute'" :label="'Attribute 1'"/>
                                <el-option :value="'Attribute2'" :label="'Attribute 2'"/>
                                <el-option :value="'Attribute3'" :label="'Attribute 3'"/>
                              </el-select>
                            </div>
                            <div class="col-1" v-if="i.attribute">
                              <el-select :name="`select_${k}_attribute_option`" v-model="i.attribute_option"
                                         :placeholder="`Select Operator`">
                                <el-option :value="'is'" :label="'is'"/>
                                <el-option :value="'not_is'" :label="'not_is'"/>
                                <el-option :value="'contains'" :label="'contains'"/>
                                <el-option :value="'contains_spaces'" :label="'contains_spaces'"/>
                                <el-option :value="'not_contain'" :label="'not_contain'"/>
                                <el-option :value="'start_with'" :label="'start_with'"/>
                                <el-option :value="'not_start_with'" :label="'not_start_with'"/>
                                <el-option :value="'end_with'" :label="'end_with'"/>
                                <el-option :value="'not_end_with'" :label="'not_end_with'"/>
                                <el-option :value="'exists'" :label="'exists'"/>
                                <el-option :value="'not_exists'" :label="'not_exists'"/>
                                <el-option :value="'is_empty'" :label="'is_empty'"/>
                                <el-option :value="'is_not_empty'" :label="'is_not_empty'"/>
                              </el-select>
                            </div>
                            <div class="col-2" v-if="i.attribute">
                              <el-select :name="`select_${k}option_value`" v-model="i.option_value"
                                         :placeholder="`Select Value`">
                              </el-select>
                            </div>
                            <div class="col-2" v-if="i.attribute">
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" v-model="i.case_sensitive"
                                       :name="`case_${k}_attribute`" :id="`case_${k}_attribute`"/>
                                <label class="form-check-label" :for="`case_${k}_attribute`">
                                  Case Sensitive
                                </label>
                              </div>
                            </div>
    ...
    <div class="card mt-5">
      <div class="card-header">
        <h4 class="card-title">Target Platform <span class="text-danger">*</span></h4>
      </div>
      <div class="card-body">
        <div class="d-flex">

          <div class="form-check">
            <input class="form-check-input" type="checkbox" v-model="platform" name="platform" value="ios"
                   id="platform1"/>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <div class="form-check">
            <input class="form-check-input" type="checkbox" v-model="platform" name="platform" value="andriod"
                   id="platform2"/>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <div class="form-check">
            <input class="form-check-input" type="checkbox" v-model="platform" name="platform" value="web"
                   id="platform3"/>
